...
export const MAIN_BOUNDARY_WIDTH_M = MAIN_BOUNDARY_SIDE_M;

export const MAIN_BOUNDARY_DEPTH_M = MAIN_BOUNDARY_SIDE_M + MAIN_BOUNDARY_NORTH_EXTENSION_M;
...
export const MOUNTAIN_GRID_SEGMENTS = 96;
