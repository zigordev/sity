export const MAIN_BOUNDARY_SIDE_M = Math.sqrt(3_000_000);

export const MAIN_BOUNDARY_NORTH_EXTENSION_M = 700;

export const MAIN_BOUNDARY_SOUTH_EXTENSION_M = 700;

export const MAIN_BOUNDARY_WEST_EXTENSION_M = 2_534;
...
export const MOUNTAIN_GRID_SEGMENTS = 180;
...
export const SNOW_MOUNTAIN_GRID_SEGMENTS = 230;
...
export const COASTAL_INLET_OVERLAP_M = 220;
...
export const BEACH_INLAND_WIDTH_M = 90;
...
export const BEACH_DUNE_COUNT = 28;

export const BEACH_GRASS_CLUSTER_COUNT = 70;

export const BEACH_UMBRELLA_COUNT = 26;

export const BEACH_SUNBED_COUNT = 52;

export const BEACH_TOWEL_COUNT = 22;

export const BEACH_TRASH_BIN_COUNT = 4;

export const NATURAL_ROCK_CLUSTER_COUNT = 36;

export const BEACH_SHELL_COUNT = 120;
...
export const MICRO_TERRAIN_CELL_M = 10;

export const WESTERN_HILLS_START_X_M = -1_800;

export const WESTERN_FOREST_HILL_HEIGHT_M = 26;

export const WESTERN_FARM_HILL_HEIGHT_M = 7;

export const WESTERN_COUNTRY_SPLIT_Z_M = 160;
...
export const ATTRACTION_PIER_LENGTH_M = 360;

export const ATTRACTION_PIER_DEPTH_M = 84;
...
export const HIGHWAY_LANE_WIDTH_M = 3.7;

export const HIGHWAY_MEDIAN_WIDTH_M = 3.6;

export const HIGHWAY_SHOULDER_WIDTH_M = 2.6;
...
export const HIGHWAY_TUNNEL_PORTAL_WIDTH_M = HIGHWAY_TOTAL_WIDTH_M + 12;

export const HIGHWAY_TUNNEL_PORTAL_HEIGHT_M = 13;

export const HIGHWAY_TUNNEL_ROCK_COLLAR_WIDTH_M = HIGHWAY_TUNNEL_PORTAL_WIDTH_M + 22;

export const HIGHWAY_TUNNEL_ROCK_COLLAR_HEIGHT_M = HIGHWAY_TUNNEL_PORTAL_HEIGHT_M + 14;

export const HIGHWAY_TUNNEL_ROCK_SLEEVE_DEPTH_M = 42;

export const HIGHWAY_TUNNEL_DARK_MASK_DEPTH_M = 26;

export const HIGHWAY_TUNNEL_MOUTH_SHADOW_WIDTH_M = HIGHWAY_TOTAL_WIDTH_M + 5;

export const HIGHWAY_TUNNEL_MOUTH_SHADOW_HEIGHT_M = HIGHWAY_TUNNEL_PORTAL_HEIGHT_M - 3;
...
export const SCALE_Z_MEASURE_M = MAIN_BOUNDARY_DEPTH_M;
