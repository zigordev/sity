...
const stadiumRoofMaterial = new THREE.MeshStandardMaterial({
  color: 0xe9ecef,
  roughness: 0.5,
  metalness: 0.3,
});
...
function buildPlaza(block: SpecialBlock) {
  ...
  for (let index = 0; index < 8; index += 1) {
    ...
    column.translate(
      cx - hallWidth * 0.5 + 6 + index * ((hallWidth - 12) / 7),
      y + 6.14,
      hallZ + hallDepth * 0.5 + 3
    );
    parts.push(column);
  }
...
function buildStadium(block: SpecialBlock) {
  ...
  const stands = new THREE.ExtrudeGeometry(shape, {
    depth: y + 17 - base + 1,
    bevelEnabled: false,
    curveSegments: 48,
  });
  ...
  const lines = mergeAll([
    (() => {
      const g = new THREE.BoxGeometry(innerX * 1.5, 0.02, 0.3);
      g.translate(cx, y + 0.52, cz - innerZ * 0.7);
      return g;
    })(),
    (() => {
      const g = new THREE.BoxGeometry(innerX * 1.5, 0.02, 0.3);
    ...
    (() => {
      const g = new THREE.BoxGeometry(0.3, 0.02, innerZ * 1.4);
      g.translate(cx - innerX * 0.75, y + 0.52, cz);
      return g;
    })(),
    (() => {
      const g = new THREE.BoxGeometry(0.3, 0.02, innerZ * 1.4);
...
function buildSchool(block: SpecialBlock) {
  ...
  batch.addBox({
    ...
    y,
    z: block.minZ + 14,
    width: block.maxX - block.minX - 12,
    height: 7.2,
    depth: 16,
    rotationY: 0,
    color,
  ...
  batch.addBox({
    ...
    depth: 26,
    rotationY: 0,
    color: new THREE.Color(0xd2d6d9),
    floorHeight: 9,
    windowWidth: 3,
    windowRatio: 0.25,
    seed: 22,
  ...
  const field = new THREE.BoxGeometry(
    block.maxX - block.minX - 30,
    0.2,
    block.maxZ - block.minZ - 60
  );
...
function buildStation(block: SpecialBlock) {
  ...
  batch.addBox(
    {
      ...
      depth: 54,
      rotationY: 0,
      color: new THREE.Color(0xd8cdb8),
      floorHeight: 4.2,
      windowWidth: 2.6,
      windowRatio: 0.55,
      seed: 41,
  ...
  batch.addBox(
    {
      ...
      y: y + 8.4,
      z: cz,
      width: (eastX - westX) * 0.5,
      height: 5.2,
      depth: 22,
      rotationY: 0,
      color: new THREE.Color(0xe8e0cf),
      floorHeight: 5.2,
      windowWidth: 3.2,
      windowRatio: 0.7,
      seed: 42,
  ...
  batch.addBox(
    {
      ...
      depth: 6,
      rotationY: 0,
      color: new THREE.Color(0xcdbfa4),
      floorHeight: 19,
      windowWidth: 1.4,
      windowRatio: 0.15,
      seed: 43,
  ...
  while (
    reach > 3 &&
    Array.from({ length: 13 }, (_, index) => -15 + index * 2.5).some(
      (dz) => pavementClearance(eastX + reach + 0.3, cz + dz, 30) < 0.6
    )
  ) {
    reach -= 0.5;
  }
...
function buildHospital(block: SpecialBlock) {
  ...
  batch.addBox(
    {
      ...
      height: 21.6,
      rotationY: 0,
      color: new THREE.Color(0xe6e9ec),
      floorHeight: 3.6,
      windowWidth: 2.4,
      windowRatio: 0.62,
      seed: 51,
  ...
  batch.addBox(
    {
      ...
      depth: 14,
      rotationY: 0,
      color: new THREE.Color(0xd5dadf),
      floorHeight: 3.4,
      windowWidth: 2,
      windowRatio: 0.2,
      seed: 52,
  ...
  batch.addBox(
    {
      ...
      depth: 34,
      rotationY: 0,
      color: new THREE.Color(0xdfe3e6),
      floorHeight: 3.6,
      windowWidth: 2.2,
      windowRatio: 0.55,
      seed: 53,
  ...
  const h = mergeAll([
    (() => {
      const g = new THREE.BoxGeometry(1.2, 0.02, 8);
      g.translate(cx - 3, y + 0.33, block.minZ + 20);
      return g;
    })(),
    (() => {
      const g = new THREE.BoxGeometry(1.2, 0.02, 8);
    ...
    (() => {
      const g = new THREE.BoxGeometry(5, 0.02, 1.2);
      g.translate(cx, y + 0.33, block.minZ + 20);
      return g;
    })(),
  ]);
  if (h) {
  ...
  const cross = mergeAll([
    (() => {
      const g = new THREE.BoxGeometry(6, 0.2, 2);
      g.translate(cx, y + 22.6, -1190);
      return g;
    })(),
    (() => {
      const g = new THREE.BoxGeometry(2, 0.2, 6);
      g.translate(cx, y + 22.6, -1190);
      return g;
    })(),
  ]);
  ...
  batch.addBox(
    {
      ...
      depth: 14,
      rotationY: 0,
      color: new THREE.Color(0xe7e3d8),
      floorHeight: 4.6,
      windowWidth: 3.2,
      windowRatio: 0.72,
      seed: 61,
...
function groundPatch(
  ...
  for (let row = 0; row < rows; row += 1) {
    for (let column = 0; column < columns; column += 1) {
      ...
      if (
        [a, a + 1, a + stride, a + stride + 1].some(
          (corner) => corridorClearance(positions[corner * 3], positions[corner * 3 + 2], 30) < 1
        )
      ) {
        continue;
      }
...
function buildGolf(block: SpecialBlock) {
  ...
  club.addBox(
    {
      ...
      depth: 16,
      rotationY: 0,
      color: new THREE.Color(0xf1ece0),
      floorHeight: 3.7,
      windowWidth: 2.6,
      windowRatio: 0.6,
      seed: 71,
  ...
  club.addRoof({
    ...
    depth: 18,
    rotationY: 0,
    color: new THREE.Color(0x6b4a3a),
  });
  ...
  for (let index = 0; index < 26; index += 1) {
    ...
    addTree(
      random() > 0.5 ? 'broadleaf' : 'conifer',
      tx,
      tz,
      groundSurfaceYAt(tx, tz),
      0.8 + random() * 0.6,
      72
    );
  }
...
function buildCampsite(block: SpecialBlock) {
  ...
  reception.addBox(
    {
      ...
      depth: 8,
      rotationY: 0,
      color: new THREE.Color(0xd7c9a8),
      floorHeight: 3.6,
      windowWidth: 2.2,
      windowRatio: 0.5,
      seed: 81,
  ...
  reception.addRoof({
    ...
    depth: 9.2,
    rotationY: 0,
    color: new THREE.Color(0x5b5f66),
  });
  reception.addBox(
    {
      x: block.minX + 44,
      ...
      depth: 7,
      rotationY: 0,
      color: new THREE.Color(0xe3ded2),
      floorHeight: 3.2,
      windowWidth: 1.4,
      windowRatio: 0.2,
      seed: 82,
...
function buildSawmill(block: SpecialBlock) {
  ...
  batch.addBox(
    {
      ...
      depth: 24,
      rotationY: 0,
      color: new THREE.Color(0x8c7a5a),
      floorHeight: 8,
      windowWidth: 4,
      windowRatio: 0.2,
      seed: 101,
  ...
  batch.addRoof({
    ...
    depth: 26,
    rotationY: 0,
    color: new THREE.Color(0x4f5257),
  });
  batch.commit(`${block.id}-buildings`);
...
function buildManor(block: SpecialBlock) {
  ...
  batch.addBox(
    {
      ...
      depth: 16,
      rotationY: 0,
      color: new THREE.Color(0xd9c9a3),
      floorHeight: 4.8,
      windowWidth: 2.4,
      windowRatio: 0.5,
      seed: 111,
  ...
  batch.addRoof({
    ...
    depth: 18,
    rotationY: 0,
    color: new THREE.Color(0x4e4a48),
  });
    ...
    batch.addBox(
      {
        ...
        depth: 12,
        rotationY: 0,
        color: new THREE.Color(0xd2c29c),
        floorHeight: 3.2,
        windowWidth: 2.0,
        windowRatio: 0.45,
        seed: 112,
  ...
  for (let index = 0; index < 14; index += 1) {
    addTree(
      'broadleaf',
      block.minX + 6 + random() * (width - 12),
      block.minZ + 6 + random() * (depth - 12),
      y,
      0.9 + random() * 0.6,
      53
    );
  ...
  batch.addBox(
    {
      ...
      y,
      z: cz + 16,
      width: block.maxX - block.minX - 10,
      height: 7,
      depth: 18,
      rotationY: 0,
      color: new THREE.Color(0xb9bfc4),
      floorHeight: 7,
      windowWidth: 4,
      windowRatio: 0.18,
      seed: 121,
    ...
    if (level < levels) {
      for (let ix = 0; ix < 5; ix += 1) {
        for (let iz = 0; iz < 5; iz += 1) {
          ...
          column.translate(
            block.minX + 3 + ix * (width / 4),
            y + level * 3.1 + 1.55,
            block.minZ + 3 + iz * (depth / 4)
          );
          columns.push(column);
        }
      }
