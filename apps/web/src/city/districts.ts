export type DistrictKind =
  'downtown' | 'midrise' | 'residential' | 'industrial' | 'coast' | 'westend' | 'alpine';
...
export const SPECIAL_BLOCKS: SpecialBlock[] = [
  ...
  { id: 'links-golf', kind: 'golf', minX: 628, maxX: 738, minZ: 1250, maxZ: 1336 },
  { id: 'south-campsite', kind: 'campsite', minX: 150, maxX: 330, minZ: 1226, maxZ: 1334 },
